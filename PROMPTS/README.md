...
- **En hvilken som helst annen gratis KI-chat i nettleseren** (Gemini,
  Mistral Le Chat, …) – kopier svaret tilbake til riktig fil.
...
- En **stor modell** (GPT-4o, Gemini Pro) til
...
1. Åpne en ny fane i nettleseren og gå til en gratis KI-chat, f.eks.
   gemini.google.com eller chat.mistral.ai
